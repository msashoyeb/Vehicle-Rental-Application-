...
<hr>
<p align="center" style="font-family:Comic Sans MS"> Home | <a href="adminAboutMe.php">About me</a> | <a href="adminEditUser.php">Edit user</a> | <a href="adminDeleteAccount.php"> Delete user account </a> | <a href="login.php">Logout</a> </p>
<hr>
